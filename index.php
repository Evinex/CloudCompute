...
if (!empty($_POST)) {
    ...
    $Fid = isset($_POST['Fid']) && !empty($_POST['Fid']) && $_POST['Fid'] != 'auto' ? $_POST['Fid'] : NULL;
    // Check if POST variable "name" exists, if not default the value to blank, basically the same for all variables
    $Strlocation = isset($_POST['Strlocation']) ? $_POST['Strlocation'] : '';
    $Destination = isset($_POST['Destination']) ? $_POST['Destination'] : '';
    $Depart = date('Y-m-d', isset($_POST['Depart']) ? strtotime($_POST['Depart']) : '');
    $Back = date('Y-m-d', isset($_POST['Back']) ? strtotime($_POST['Back']) : '');
    $Way = isset($_POST['Way']) ? $_POST['Way'] : '';
    // Insert new record into the contacts table
    $stmt = $pdo->prepare('INSERT INTO flight (Strlocation, Destination, Depart, Back, Way) VALUES (?, ?, ?, ?, ?)');
    $stmt->execute([$Strlocation, $Destination, $Depart, $Back, $Way]);
    // Output message
    $msg = 'Flight Plan Has Been Created Successfully!';
}
?> 
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="left-side">
                        <div class="logo">
                            <img src="img/AirAsia-Logo.png" alt="Flight Template">
                        </div>
                        <div class="tabs-content">
                            <h4>Welcome to Air Asia!</h4>
                            <ul class="social-links">
                                ...
                                <li><a href="DisplayFlight.php">Take a look at your <em>Flight Plans</em></a></li>
                            </ul>
                        </div>
                    ...
                    <section id="first-tab-group" class="tabgroup">
                        <div id="tab1">
                            <div class="submit-form">
                                <h4>Create a Flight Plan <em>Today </em>:</h4>
                                <form id="form-submit" action="index.php" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset>
                                                <label for="Strlocation">From:</label>
                                                <select required name='Strlocation' id="Strlocation" onchange='this.form.()'>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <select required name='Destination' id="Destination" onchange='this.form.()'>
                                                    <option value="">Select a location...</option>
                                                    <option value="Cambodia">Cambodia</option>
                                                    <option value="Hong Kong">Hong Kong</option>
                                                    <option value="India">India</option>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <input name="Depart" type="text" class="form-control date" id="Depart" placeholder="Select date..." required onchange='this.form.()'>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset>
                                                <label for="back">Return date:</label>
                                               <input name="Back" type="text" class="form-control date" id="Back" placeholder="Select date..." required onchange='this.form.()'>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="radio-select">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                                        ...
                                                        <input type="radio" name="Way" id="Way" value="Round" requiredonchange='this.form.()'>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                                        <label for="oneway">Oneway</label>
                                                        <input type="radio" name="Way" id="Way" value="One-way" requiredonchange='this.form.()'>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset>
                                                <button type="submit" id="form-submit" class="btn" value="Create">Order Ticket Now</button>
                                            </fieldset>
                                        </div>
                                    </div>
                                </form>
